            ...
            <div class="col-md">
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control w-50" id="tanggal_lahir" value="<?= $siswa['tanggal_lahir']; ?>" name="tanggal_lahir" autocomplete="off" required>
                    </div>
                    </div>
                    <div class="mb-3">
                        <label for="telepon" class="form-label">Telepon</label>
                        <input type="number" class="form-control w-50" id="telepon" value="<?= $siswa['telepon']; ?>" name="telepon" autocomplete="off" required>
                    </div>
                    <div class="mb-3">
                        <label for="kesukaan" class="form-label">Kesukaan</label>
                        <input type="text" class="form-control w-50" id="kesukaan" value="<?= $siswa['kesukaan']; ?>" name="kesukaan" autocomplete="off" required>
                    </div>
                    <hr>
