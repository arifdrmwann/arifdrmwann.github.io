            ...
            <div class="col-md">
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control w-50" id="tanggal_lahir" placeholder="Masukkan Tanggal Lahir" name="tanggal_lahir" autocomplete="off" required>
                    </div>
                    <div class="mb-3">
                        <label for="telepon" class="form-label">Telepon</label>
                        <input type="number" class="form-control w-50" id="telepon" placeholder="Masukkan NO Telepon" name="telepon" autocomplete="off" required>
                    </div>
                    <div class="mb-3">
                        <label for="kesukaan" class="form-label">Kesukaan</label>
                        <input type="text" class="form-control  w-50" id="kesukaan" placeholder="Masukkan Kesukaan" name="kesukaan" autocomplete="off" required>
                    </div>
